...
from custom_components.brunata_online.api.brunata_api.models import (
    ConsumptionValueDto,
...
class MeterReader:
    ...
    def configure_metadata(
        self,
        mappers_config: MappersConfiguration,
        ...
        for meter in meters.root:
            ...
            value_category = mappers_config.allocationUnitMap[
                meter.meter.allocationUnit
            ]
    ...
    def enrich_consumption_data(
        self, consumption_data: ConsumptionResult
    ) -> list[ConsumptionReading]:
        result = [
            ConsumptionReading(
                Meter=self.meters[line.meter.meterId], Values=line.consumptionValues
            )
