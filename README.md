...
Thanks to everyone who has contributed to this project and its upstream fork ([rien/ha-brunata](https://github.com/rien/ha-brunata)):

- [@YukiElectronics-YT](https://github.com/YukiElectronics-YT) — original author
- [@hoffmann-thomas](https://github.com/hoffmann-thomas) — maintainer
- [@rien](https://github.com/rien)
